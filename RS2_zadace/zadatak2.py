# 1. Koristeci funkciju map, kvadrirajte duljine svih nizova u listi
nizovi = ["jabuka", "kruška", "banana", "naranča"]

kvadrirane_duljine = list(map(lambda x : len(x) ** 2, nizovi))
print(kvadrirane_duljine)

# 2. Koristeci funkciju filter, filtrirajte samo brojeve koji su veci od 5
...
# 4. Koristeci funkcije all i map, provjerite jesu li svi studneti punoljetni
studenti = [
